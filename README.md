...
Conains solutions to decipticode problems. Round 2 required us to code simple questions in [ArnoldC](http://lhartikk.github.io/ArnoldC/) . 

The [questions](Questions) folder contains the documentation and the questions. 

You can also find the samples in the [samples](samples) folder

The solutions can be found in the [workspace](workspace) folder.

# Solution links

[Solution 1](workspace/sol1.arnoldc) - Print square of numbers

[Solution 2](workspace/sol2.arnoldc) - Print fibonacci till n

[Solution 3](workspace/sol3.arnoldc) - Print modulo of 2 numbers

[Solution 4](workspace/sol4.arnoldc) - Print sum of multiples of 3 and 5 till n

[Solution 5](workspace/sol5.arnoldc) - If number is a multiple of 3 print fizz, if number is a multiple of 5 print buzz and if number if multiple of 3 and 5 print fizzbuzz
